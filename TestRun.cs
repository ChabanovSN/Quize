...
namespace SecondForms
{
    ...
    class Test {
        ...
        public Dictionary<string, int> ListsOfAnswers { get; set; } 
        public Test()
        {
    ...
    public class TestRun
    {
        ...
        public TestRun(string path )
        {
            ...
            Console.WriteLine($"TestRun {path}");
            Path = path;
          //  text = File.ReadAllText(path);

           
        }
       internal List<Test> ReadFile() {
          ...
          void ReadListTest(List<Test> tests){ 
        ...
        internal List<Test> GetListTests() {
       ...
       public void _Write()
        {
            ...
            {
["вселенец"]= 5,
["акклиматизированный вид"]= 0,
["акклиматизированный подвид"]= 0,
["акклиматизированная особь"]= 0
            }
        };
